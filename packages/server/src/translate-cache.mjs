...
// purge 命令删除整个 SKILLHELPER_HOME 目录，本缓存文件随之清理。
...
function getMaxEntries() {
  return parseInt(process.env.SKILLHELPER_TRANSLATE_CACHE_MAX || '5000', 10);
}
...
/**
 * 重置缓存（仅测试用：清空内存并标记未加载，以便切换 SKILLHELPER_HOME 后重新加载）
 */
